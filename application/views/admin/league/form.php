...
<table>
    ...
    <tr>
        <td><?php echo form_label('Short Name', $short_name['name']); ?></td>
    ...
    <tr>
        <td><?php echo form_label('Points for win', $points_for_win['name']); ?></td>
        ...
        <td><?php echo form_label('Points for draw', $points_for_draw['name']); ?></td>
