...
<table>
    ...
    <tr>
        <td><?php echo form_label($this->lang->line('league_registration_league'), $league_id['name']); ?></td>
    ...
    <tr>
        <td><?php echo form_label($this->lang->line('league_registration_team'), $opposition_id['name']); ?></td>
