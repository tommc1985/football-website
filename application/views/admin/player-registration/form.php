...
<table>
    ...
    <tr>
        <td><?php echo form_label($this->lang->line('player_registration_player'), $player_id['name']); ?></td>
    ...
    <tr>
        <td><?php echo form_label($this->lang->line('player_registration_season'), $season['name']); ?></td>
