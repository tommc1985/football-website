...
class Fantasy_Football_model extends Base_Frontend_Model {
    ...
    public function __construct()
    {
        ...
        $this->formations = array(
            ...
            '4-3-2-1' => array(
                'name' => '4-3-2-1',
                'positions' => array("gk", "rb", "lb", "cb1", "cb2", "cm1", "cm2", "cm3", "am1", "am2", "st1", "sub2", "sub3", "sub4", "sub5"),
            ),
            '5-3-2' => array(
                'name' => '5-3-2',
            ...
            '4-2-3-1' => array(
                'name' => '4-2-3-1',
                'positions' => array("gk", "rb", "lb", "cb1", "cb2", "dm1", "dm2", "rm", "lm", "am1", "st1", "sub2", "sub3", "sub4", "sub5"),
            ),
            '5-4-1' => array(
                'name' => '5-4-1',
