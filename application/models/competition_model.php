...
class Competition_model extends Base_Model {
    ...
    public function formValidation()
    {
        ...
        $this->ci->form_validation->set_rules('type', 'Type', 'trim|required|xss_clean');
        $this->ci->form_validation->set_rules('starts', 'Starts', 'trim|required|is_natural_no_zero|xss_clean');
        $this->ci->form_validation->set_rules('subs', 'Substitutes', 'trim|required|is_natural|xss_clean');
        $this->ci->form_validation->set_rules('competitive', 'Competitive', 'trim|required|is_natural|xss_clean');
    }
