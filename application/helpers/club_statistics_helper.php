...
class Club_Statistics_helper
{
    ...
    protected static function _displayNoData($statisticGroup)
    {
        ...
        <h3 id="<?php echo $statisticGroup;?>"><?php echo $ci->lang->line("club_statistics_{$statisticGroup}"); ?></h3>
        <p><?php echo $ci->lang->line("club_statistics_{$statisticGroup}_explanation"); ?></p>
    ...
    protected static function _displayMatches($matches, $statisticGroup)
    {
        ...
        echo "<h3 id='{$statisticGroup}'>" . $ci->lang->line("club_statistics_{$statisticGroup}") . '</h3>'; ?>
        <p><?php echo $ci->lang->line("club_statistics_{$statisticGroup}_explanation"); ?></p>
        <?php
    ...
    protected static function _displaySequences($sequences, $statisticGroup, $season)
    {
        ...
        if ($season == Season_model::fetchCurrentSeason()) { ?>
            <p class="muted"><small><?php echo $ci->lang->line("club_statistics_ongoing_denotes"); ?></small></p>
        <?php
        }
    }
